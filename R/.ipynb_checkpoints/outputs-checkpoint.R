    ...
    output[[.ui_markdown_overview]] <- renderUI({
        ...
        if (!length(dataset_selected_id)) {
            ...
            contents <- markdown(paste0(
                ...
                "**GEO ID:** ", dataset_info$geo, "\n\n",
                "**ENCODE ID:** ", dataset_info$encode, "\n\n",
                 "**PMID:** ", dataset_info$PMID, "\n\n",
                 "**Organism:** ", dataset_info$Organism, "\n\n",
                "**ResourceName:** ", dataset_info$ResourceName, "\n\n",
                "**LibraryType:** ", dataset_info$LibraryType, "\n\n",
                 "**Contact:** ", dataset_info$contact, "\n\n",
